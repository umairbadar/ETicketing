...
public class TicketListing extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lview.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(TicketListing.this, TicketDetail.class);
                i.putExtra("Id", sno);
    ...
    public void TicketList() {
        ...
        if (RoleName.equals("reporting manager"))
        {
            ...
            //Toast.makeText(getApplicationContext(),"Reporting Manager",Toast.LENGTH_LONG).show();
            finish();
                ...
                StringRequest req = new StringRequest(url,
                                ...
                                if (response != null) {
                                    try {
                                        ...
                                        if (msg.equals("failed")) {
                                            ...
                                            listviewAdapter adapter = new listviewAdapter(TicketListing.this, Ticketlist);
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                Toast.makeText(TicketListing.this, error.toString(), Toast.LENGTH_LONG).show();
                            }
                        }
                );
                        ...
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    {
                                        JSONArray jsonArray = jsonObject.getJSONArray("accepted_tickets");
                                        String id, ticket_title, sitename;
                                        for (int i = 0; i < jsonArray.length(); i++)
                                        {
                                            JSONObject object = jsonArray.getJSONObject(i);
            ...
            else if (A.equals("myAssignments"))
            {
                final String url = "http://" + Survey_Login.IP + "/api/my-assignments/" + UserID;
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            JSONObject object = jsonArray.getJSONObject(i);
                                            JSONObject innerObj = object.getJSONObject("find_ticket");
                                            id = innerObj.getString("id");
                                            sitename = innerObj.getString("ticket_site_name");
                                            ticket_title = innerObj.getString("ticket_title");
                                            Model item = new Model(id, ticket_title, sitename);
                                            Ticketlist.add(item);
                                        }
                                        listviewAdapter adapter = new listviewAdapter(TicketListing.this, Ticketlist);
