...
public class SurveyListManager extends AppCompatActivity {

    private String TAG = SurveyListManager.class.getSimpleName();
    ...
    String UserID,RoleID,RoleName,DeptID,A;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_survey_list_manager);
        ...
        DeptID = intent.getStringExtra("DepartID");
        ...
        lview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(SurveyListManager.this, SurveyDetail.class);
                i.putExtra("Id",sno);
                i.putExtra("sury",sur);
            ...
            StringRequest req = new StringRequest(url,
                            ...
                            if (response != null) {
                                try {
                                    ...
                                    if (msg.equals("failed")) {
                                        ...
                                        listviewSAdapter adapter = new listviewSAdapter(SurveyListManager.this, Surveylist);
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(SurveyListManager.this, error.toString(), Toast.LENGTH_LONG).show();
                        }
                    }
            );
